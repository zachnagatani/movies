...
# A single movie entry html template. This gets inserted into {movie_tiles}
movie_tile_content = '''
...
# Called by open_movies_pages and returns the properties from the instances of Movie needed to display the movies
...
# Called in entertainment_center to compile our HTML
