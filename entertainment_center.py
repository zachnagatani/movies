...
# Batman movies
batman_begins = movies.Movie('Batman Begins', 'After training with his ' +
...
the_dark_knight = movies.Movie('The Dark Knight', 'Batman faces a new ' +
...
the_dark_knight_rises = movies.Movie('The Dark Knight Rises', 'Eight ' +
...
# Bourne movies
the_bourne_identity = movies.Movie('The Bourne Identity', 'A man ' +
...
the_bourne_supremacy = movies.Movie('The Bourne Supremacy', 'When ' +
                                    ...
                                    'Y-HqyyfBbSo')
the_bourne_ultimatum = movies.Movie('The Bourne Ultimatum', 'Jason ' +
...
movies_list = [batman_begins, the_dark_knight, the_dark_knight_rises,
               the_bourne_identity, the_bourne_supremacy, the_bourne_ultimatum]

# Open the movies page from fresh_tomatoes, which compiles our HTML
# and launches the page
